...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Automate customer support, lead qualification and sales follow-ups with premium AI Employees on WhatsApp, Voice and Email. Join 1000+ businesses saving $2,500+ monthly." },
      { property: "og:title", content: "Indu Divine AI — AI Employees That Work 24/7" },
      { property: "og:description", content: "Automate customer support, lead qualification and sales follow-ups with premium AI Employees on WhatsApp, Voice and Email." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Indu Divine AI — AI Employees That Work 24/7" },
      { name: "twitter:description", content: "Premium AI automation for WhatsApp, Voice, Email and lead management." },
